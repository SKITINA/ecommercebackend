...
app.get('/', (req, res) => {
  res.json({
    ...
    architecture: 'MVC avec contrôleurs séparés',
    endpoints: {
...
app.listen(PORT, () => {
  ...
  console.log('🛒 E-commerce Backend Server (MVC Architecture)');
  console.log('='.repeat(50));
  ...
  console.log('='.repeat(50));
  console.log('🏗️  Architecture: MVC avec contrôleurs séparés');
  console.log('='.repeat(50));
});
